package uk.gov.hmcts.reform.divorce.validationservice.management.config;
...
public class SwaggerConfiguration implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage(ValidationServiceApplication.class.getPackage().getName()))
                .build()
