...
public class RespondentLastNameTest {
    ...
    @Test
    public void whenShouldReturnTrueWhenRespondentLastNameIsNull() {
    ...
    @Test
    public void whenShouldReturnFalseWhenRespondentLastNameIsNotNull() {
        divorceSession.setRespondentLastName("Yes");
    ...
    public void thenShouldReturnErrorMessageWithNull() {
        ...
        assertEquals("respondentLastName can not be null or empty. Actual data is: null", rule.getResult());
    }
}