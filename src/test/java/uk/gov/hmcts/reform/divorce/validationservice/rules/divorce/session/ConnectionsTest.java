...
public class ConnectionsTest {
    ...
    private uk.gov.hmcts.reform.divorce.validationservice.domain.request.Connections connections;
    ...
    public void whenShouldReturnFalseWhenConnectionsIsNotNull() {
        connections = new uk.gov.hmcts.reform.divorce.validationservice.domain.request.Connections();
    ...
    public void thenShouldReturnErrorMessageWithNull() {
        ...
        assertEquals("connections can not be null or empty. Actual data is: null", rule.getResult());
    }
}