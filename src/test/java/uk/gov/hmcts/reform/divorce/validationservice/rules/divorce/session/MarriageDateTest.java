...
public class MarriageDateTest {
    ...
    public void thenShouldReturnErrorMessageWithNull() {
        ...
        assertEquals("marriageDate can not be null or empty. Actual data is: null", rule.getResult());
    }
    ...
    public void thenShouldReturnErrorMessageWhenMarriageDateLessThanOneYearAgo() {
        ...
        assertEquals("marriageDate can not be less than one year ago. Actual data is: ".concat(marriageDate.toString()), rule.getResult());
    }
    ...
    public void thenShouldReturnErrorMessageWhenMarriageDateMoreThanOneHundredYearsAgo() {
        ...
        assertEquals("marriageDate can not be more than 100 years ago. Actual data is: ".concat(marriageDate.toString()), rule.getResult());
    }
    ...
    public void thenShouldReturnErrorMessageWhenMarriageDateIsInTheFuture() {
        ...
        assertEquals("marriageDate can not be in the future. Actual data is: ".concat(marriageDate.toString()), rule.getResult());
    }
}