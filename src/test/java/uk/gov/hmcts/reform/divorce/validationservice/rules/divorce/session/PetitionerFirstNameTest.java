...
public class PetitionerFirstNameTest {
    ...
    @Test
    public void whenShouldReturnTrueWhenPetitionerFirstNameIsNull() {
    ...
    @Test
    public void whenShouldReturnFalseWhenPetitionerFirstNameIsNotNull() {
        divorceSession.setPetitionerFirstName("Yes");
    ...
    public void thenShouldReturnErrorMessageWithNull() {
        ...
        assertEquals("petitionerFirstName can not be null or empty. Actual data is: null", rule.getResult());
    }
}